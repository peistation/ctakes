...
import static edu.mayo.bmi.nlp.tokenizer.TokenizerHelper.HYPHEN_OR_MINUS_SIGN;
import static edu.mayo.bmi.nlp.tokenizer.TokenizerHelper.NEWLINE;
import static edu.mayo.bmi.nlp.tokenizer.TokenizerHelper.PERIOD;
import static edu.mayo.bmi.nlp.tokenizer.TokenizerHelper.isPunctuation;
...
public class TokenizerPTB {
	 ...
	 * if jcas is null,  
	 * @see edu.mayo.bmi.uima.core.ae.TokenConverter#convert(edu.mayo.bmi.nlp.tokenizer.Token, org.apache.uima.jcas.JCas, int)
	 */
	...
	/**
	 * @see edu.mayo.bmi.nlp.tokenizer.Tokenizer#isNumber
	 */
	private void setNumType(NumToken nta, String tokenText) {
	    if (edu.mayo.bmi.nlp.tokenizer.Tokenizer.isNumber(tokenText) && !tokenText.contains(".")) {
	...
	/**
	 * @see edu.mayo.bmi.nlp.tokenizer.Tokenizer#applyCapitalizationRules
	 */
