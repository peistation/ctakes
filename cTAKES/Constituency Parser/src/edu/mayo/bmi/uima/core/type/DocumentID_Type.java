...
public class DocumentID_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.DocumentID");
  ...
  public String getDocumentID(int addr) {
      ...
      jcas.throwFeatMissing("documentID", "edu.mayo.bmi.uima.core.type.DocumentID");
