...
public class TerminalTreebankNode_Type extends TreebankNode_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.chboston.cnlp.ctakes.parser.uima.type.TerminalTreebankNode");
  ...
  public int getIndex(int addr) {
      ...
      jcas.throwFeatMissing("index", "org.chboston.cnlp.ctakes.parser.uima.type.TerminalTreebankNode");
  ...
  public int getTokenIndex(int addr) {
      ...
      jcas.throwFeatMissing("tokenIndex", "org.chboston.cnlp.ctakes.parser.uima.type.TerminalTreebankNode");
