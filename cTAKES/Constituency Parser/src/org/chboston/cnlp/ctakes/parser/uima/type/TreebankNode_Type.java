...
/* First created by JCasGen Thu Dec 01 13:26:32 EST 2011 */
...
public class TreebankNode_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public String getNodeType(int addr) {
      ...
      jcas.throwFeatMissing("nodeType", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public String getNodeValue(int addr) {
      ...
      jcas.throwFeatMissing("nodeValue", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public boolean getLeaf(int addr) {
      ...
      jcas.throwFeatMissing("leaf", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public int getParent(int addr) {
      ...
      jcas.throwFeatMissing("parent", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public int getChildren(int addr) {
      ...
      jcas.throwFeatMissing("children", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public int getNodeTags(int addr) {
      ...
      jcas.throwFeatMissing("nodeTags", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public int getHeadIndex(int addr) {
      ...
      jcas.throwFeatMissing("headIndex", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode");
  ...
  public TreebankNode_Type(JCas jcas, Type casType) {
    ...
    casFeat_parent = jcas.getRequiredFeatureDE(casType, "parent", "org.chboston.cnlp.ctakes.parser.uima.type.TreebankNode", featOkTst);
