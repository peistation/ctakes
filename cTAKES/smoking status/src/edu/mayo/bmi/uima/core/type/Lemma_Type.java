...
public class Lemma_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.Lemma");
  ...
  public String getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "edu.mayo.bmi.uima.core.type.Lemma");
  ...
  public String getPosTag(int addr) {
      ...
      jcas.throwFeatMissing("posTag", "edu.mayo.bmi.uima.core.type.Lemma");
