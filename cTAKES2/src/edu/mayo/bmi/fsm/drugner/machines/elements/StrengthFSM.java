...
public class StrengthFSM {
	...
	private Machine getStrengthMachine(){
		...
		startState.addTransition(new WordSetCondition(
				iv_numberTextSet, false), hyphenState);
		startState.addTransition(new AnyCondition(), startState);
		
		connectState.addTransition(new WordSetCondition(iv_fullTextSet, false), endState);
		...
		connectState.addTransition(new WordSetCondition(iv_oneOfTwoTextSet, false), complexState);
		connectState.addTransition(new ContainsSetTextValueCondition(
				iv_fullTextSet, false), endState);
		connectState.addTransition(new AnyCondition(), startState);
		
		decimalState.addTransition(new ContainsSetTextValueCondition(iv_fullTextSet, false), endState);
		...
		unitState.addTransition(new WordSetCondition(iv_fullTextSet, false), endState);
		...
		complexState.addTransition(new WordSetCondition(iv_twoOfTwoTextSet, false), endState);
		complexState.addTransition(new AnyCondition(), startState);
		
		hyphenState.addTransition(new ContainsSetTextValueCondition(iv_fullTextSet, false), endState);
		hyphenState.addTransition(new WordSetCondition(iv_fullTextSet, false), endState);
