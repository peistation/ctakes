 ...
 */
public class NonSmokerNamedEntityLookupConsumerImpl extends BaseLookupConsumerImpl
		implements LookupConsumer
{
	...
	public NonSmokerNamedEntityLookupConsumerImpl(AnnotatorContext aCtx, Properties props)
	{
