...
public class Element_Type extends TOP_Type {
  ...
  public int getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public int getOntologyConcept(int addr) {
      ...
      jcas.throwFeatMissing("ontologyConcept", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public int getMentions(int addr) {
      ...
      jcas.throwFeatMissing("mentions", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  /** @generated */ 
  public String getDiscoveryTechnique(int addr) {
        if (featOkTst && casFeat_discoveryTechnique == null)
      jcas.throwFeatMissing("discoveryTechnique", "edu.mayo.bmi.uima.core.type.refsem.Element");
    return ll_cas.ll_getStringValue(addr, casFeatCode_discoveryTechnique);
  }
  /** @generated */    
  public void setDiscoveryTechnique(int addr, String v) {
        if (featOkTst && casFeat_discoveryTechnique == null)
      jcas.throwFeatMissing("discoveryTechnique", "edu.mayo.bmi.uima.core.type.refsem.Element");
    ll_cas.ll_setStringValue(addr, casFeatCode_discoveryTechnique, v);}
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public boolean getConditional(int addr) {
      ...
      jcas.throwFeatMissing("conditional", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public boolean getGeneric(int addr) {
      ...
      jcas.throwFeatMissing("generic", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public String getSubject(int addr) {
      ...
      jcas.throwFeatMissing("subject", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public int getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "edu.mayo.bmi.uima.core.type.refsem.Element");
  ...
  public Element_Type(JCas jcas, Type casType) {
    ...
    casFeat_ontologyConcept = jcas.getRequiredFeatureDE(casType, "ontologyConcept", "edu.mayo.bmi.uima.core.type.refsem.OntologyConcept", featOkTst);
    ...
    casFeat_discoveryTechnique = jcas.getRequiredFeatureDE(casType, "discoveryTechnique", "uima.cas.String", featOkTst);
