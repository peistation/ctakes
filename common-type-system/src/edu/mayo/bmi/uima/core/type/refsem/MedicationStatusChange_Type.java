...
public class MedicationStatusChange_Type extends Attribute_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.MedicationStatusChange");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "edu.mayo.bmi.uima.core.type.refsem.MedicationStatusChange");
