...
public class MedicationStrength_Type extends Attribute_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.MedicationStrength");
  ...
  public String getNumber(int addr) {
      ...
      jcas.throwFeatMissing("number", "edu.mayo.bmi.uima.core.type.refsem.MedicationStrength");
  ...
  public String getUnit(int addr) {
      ...
      jcas.throwFeatMissing("unit", "edu.mayo.bmi.uima.core.type.refsem.MedicationStrength");
