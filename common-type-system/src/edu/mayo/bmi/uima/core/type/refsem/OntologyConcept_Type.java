...
public class OntologyConcept_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.OntologyConcept");
  ...
  public String getCodingScheme(int addr) {
      ...
      jcas.throwFeatMissing("codingScheme", "edu.mayo.bmi.uima.core.type.refsem.OntologyConcept");
  ...
  public String getCode(int addr) {
      ...
      jcas.throwFeatMissing("code", "edu.mayo.bmi.uima.core.type.refsem.OntologyConcept");
  ...
  public String getOid(int addr) {
      ...
      jcas.throwFeatMissing("oid", "edu.mayo.bmi.uima.core.type.refsem.OntologyConcept");
  ...
  public String getOui(int addr) {
      ...
      jcas.throwFeatMissing("oui", "edu.mayo.bmi.uima.core.type.refsem.OntologyConcept");
