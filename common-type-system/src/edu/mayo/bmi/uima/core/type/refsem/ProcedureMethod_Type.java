...
public class ProcedureMethod_Type extends Attribute_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.ProcedureMethod");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "edu.mayo.bmi.uima.core.type.refsem.ProcedureMethod");
