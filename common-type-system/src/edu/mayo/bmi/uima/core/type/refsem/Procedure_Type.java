...
public class Procedure_Type extends Event_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getBodyLaterality(int addr) {
      ...
      jcas.throwFeatMissing("bodyLaterality", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getBodySide(int addr) {
      ...
      jcas.throwFeatMissing("bodySide", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getBodyLocation(int addr) {
      ...
      jcas.throwFeatMissing("bodyLocation", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getProcedureDevice(int addr) {
      ...
      jcas.throwFeatMissing("procedureDevice", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getDuration(int addr) {
      ...
      jcas.throwFeatMissing("duration", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getMethod(int addr) {
      ...
      jcas.throwFeatMissing("method", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getStartTime(int addr) {
      ...
      jcas.throwFeatMissing("startTime", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public int getRelativeTemporalContext(int addr) {
      ...
      jcas.throwFeatMissing("relativeTemporalContext", "edu.mayo.bmi.uima.core.type.refsem.Procedure");
  ...
  public Procedure_Type(JCas jcas, Type casType) {
    ...
    casFeat_procedureDevice = jcas.getRequiredFeatureDE(casType, "procedureDevice", "edu.mayo.bmi.uima.core.type.refsem.ProcedureDevice", featOkTst);
    ...
    casFeat_method = jcas.getRequiredFeatureDE(casType, "method", "edu.mayo.bmi.uima.core.type.refsem.ProcedureMethod", featOkTst);
