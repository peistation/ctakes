...
public class SignSymptom_Type extends Event_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getAlleviatingFactor(int addr) {
      ...
      jcas.throwFeatMissing("alleviatingFactor", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getBodyLaterality(int addr) {
      ...
      jcas.throwFeatMissing("bodyLaterality", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getBodySide(int addr) {
      ...
      jcas.throwFeatMissing("bodySide", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getBodyLocation(int addr) {
      ...
      jcas.throwFeatMissing("bodyLocation", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getCourse(int addr) {
      ...
      jcas.throwFeatMissing("course", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getDuration(int addr) {
      ...
      jcas.throwFeatMissing("duration", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getEndTime(int addr) {
      ...
      jcas.throwFeatMissing("endTime", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getExacerbatingFactor(int addr) {
      ...
      jcas.throwFeatMissing("exacerbatingFactor", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public String getSeverity(int addr) {
      ...
      jcas.throwFeatMissing("severity", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getStartTime(int addr) {
      ...
      jcas.throwFeatMissing("startTime", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
  ...
  public int getRelativeTemporalContext(int addr) {
      ...
      jcas.throwFeatMissing("relativeTemporalContext", "edu.mayo.bmi.uima.core.type.refsem.SignSymptom");
