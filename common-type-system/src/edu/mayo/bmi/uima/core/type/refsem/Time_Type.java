...
public class Time_Type extends Element_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.refsem.Time");
  ...
  public String getNormalizedForm(int addr) {
      ...
      jcas.throwFeatMissing("normalizedForm", "edu.mayo.bmi.uima.core.type.refsem.Time");
