...
public class BinaryTextRelation_Type extends Relation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.relation.BinaryTextRelation");
  ...
  public int getArg1(int addr) {
      ...
      jcas.throwFeatMissing("arg1", "edu.mayo.bmi.uima.core.type.relation.BinaryTextRelation");
  ...
  public int getArg2(int addr) {
      ...
      jcas.throwFeatMissing("arg2", "edu.mayo.bmi.uima.core.type.relation.BinaryTextRelation");
  ...
  public BinaryTextRelation_Type(JCas jcas, Type casType) {
    ...
    casFeat_arg1 = jcas.getRequiredFeatureDE(casType, "arg1", "edu.mayo.bmi.uima.core.type.relation.RelationArgument", featOkTst);
    casFeatCode_arg1  = (null == casFeat_arg1) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_arg1).getCode();

 
    casFeat_arg2 = jcas.getRequiredFeatureDE(casType, "arg2", "edu.mayo.bmi.uima.core.type.relation.RelationArgument", featOkTst);
