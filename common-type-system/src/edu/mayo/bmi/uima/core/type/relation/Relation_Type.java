...
public class Relation_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.relation.Relation");
  ...
  public int getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.mayo.bmi.uima.core.type.relation.Relation");
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "edu.mayo.bmi.uima.core.type.relation.Relation");
  ...
  public String getDiscoveryTechnique(int addr) {
      ...
      jcas.throwFeatMissing("discoveryTechnique", "edu.mayo.bmi.uima.core.type.relation.Relation");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "edu.mayo.bmi.uima.core.type.relation.Relation");
  ...
  public int getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "edu.mayo.bmi.uima.core.type.relation.Relation");
  ...
  public String getUncertainty(int addr) {
      ...
      jcas.throwFeatMissing("uncertainty", "edu.mayo.bmi.uima.core.type.relation.Relation");
