...
public class Demographics_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getBirthDate(int addr) {
      ...
      jcas.throwFeatMissing("birthDate", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getDeathDate(int addr) {
      ...
      jcas.throwFeatMissing("deathDate", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getGender(int addr) {
      ...
      jcas.throwFeatMissing("gender", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getFirstName(int addr) {
      ...
      jcas.throwFeatMissing("firstName", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getMiddleName(int addr) {
      ...
      jcas.throwFeatMissing("middleName", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getLastName(int addr) {
      ...
      jcas.throwFeatMissing("lastName", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getFirstNameSoundex(int addr) {
      ...
      jcas.throwFeatMissing("firstNameSoundex", "edu.mayo.bmi.uima.core.type.structured.Demographics");
  ...
  public String getLastNameSoundex(int addr) {
      ...
      jcas.throwFeatMissing("lastNameSoundex", "edu.mayo.bmi.uima.core.type.structured.Demographics");
