...
public class SourceData_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getNoteTypeCode(int addr) {
      ...
      jcas.throwFeatMissing("noteTypeCode", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getNoteSubTypeCode(int addr) {
      ...
      jcas.throwFeatMissing("noteSubTypeCode", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getAuthorSpecialty(int addr) {
      ...
      jcas.throwFeatMissing("authorSpecialty", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getDocumentStandard(int addr) {
      ...
      jcas.throwFeatMissing("documentStandard", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getSourceInstanceId(int addr) {
      ...
      jcas.throwFeatMissing("sourceInstanceId", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public int getSourceRevisionNbr(int addr) {
      ...
      jcas.throwFeatMissing("sourceRevisionNbr", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getSourceRevisionDate(int addr) {
      ...
      jcas.throwFeatMissing("sourceRevisionDate", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getSourceOriginalDate(int addr) {
      ...
      jcas.throwFeatMissing("sourceOriginalDate", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getSourceInstitution(int addr) {
      ...
      jcas.throwFeatMissing("sourceInstitution", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getSourceEncounterId(int addr) {
      ...
      jcas.throwFeatMissing("sourceEncounterId", "edu.mayo.bmi.uima.core.type.structured.SourceData");
  ...
  public String getSourceApplication(int addr) {
      ...
      jcas.throwFeatMissing("sourceApplication", "edu.mayo.bmi.uima.core.type.structured.SourceData");
