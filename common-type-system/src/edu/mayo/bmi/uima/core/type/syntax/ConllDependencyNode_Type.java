...
public class ConllDependencyNode_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public int getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getForm(int addr) {
      ...
      jcas.throwFeatMissing("form", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getLemma(int addr) {
      ...
      jcas.throwFeatMissing("lemma", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getCpostag(int addr) {
      ...
      jcas.throwFeatMissing("cpostag", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getPostag(int addr) {
      ...
      jcas.throwFeatMissing("postag", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getFeats(int addr) {
      ...
      jcas.throwFeatMissing("feats", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public int getHead(int addr) {
      ...
      jcas.throwFeatMissing("head", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getDeprel(int addr) {
      ...
      jcas.throwFeatMissing("deprel", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public int getPhead(int addr) {
      ...
      jcas.throwFeatMissing("phead", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public String getPdeprel(int addr) {
      ...
      jcas.throwFeatMissing("pdeprel", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode");
  ...
  public ConllDependencyNode_Type(JCas jcas, Type casType) {
    ...
    casFeat_head = jcas.getRequiredFeatureDE(casType, "head", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode", featOkTst);
    ...
    casFeat_phead = jcas.getRequiredFeatureDE(casType, "phead", "edu.mayo.bmi.uima.core.type.syntax.ConllDependencyNode", featOkTst);
