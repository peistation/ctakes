...
public class TerminalTreebankNode_Type extends TreebankNode_Type {
  ...
  public int getIndex(int addr) {
      ...
      jcas.throwFeatMissing("index", "edu.mayo.bmi.uima.core.type.syntax.TerminalTreebankNode");
  ...
  public int getTokenIndex(int addr) {
      ...
      jcas.throwFeatMissing("tokenIndex", "edu.mayo.bmi.uima.core.type.syntax.TerminalTreebankNode");
