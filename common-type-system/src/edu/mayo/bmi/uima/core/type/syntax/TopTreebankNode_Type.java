...
public class TopTreebankNode_Type extends TreebankNode_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.syntax.TopTreebankNode");
  ...
  public String getTreebankParse(int addr) {
      ...
      jcas.throwFeatMissing("treebankParse", "edu.mayo.bmi.uima.core.type.syntax.TopTreebankNode");
  ...
  public int getTerminals(int addr) {
      ...
      jcas.throwFeatMissing("terminals", "edu.mayo.bmi.uima.core.type.syntax.TopTreebankNode");
