...
public class TreebankNode_Type extends Annotation_Type {
  ...
  public String getNodeType(int addr) {
      ...
      jcas.throwFeatMissing("nodeType", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode");
  ...
  public String getNodeValue(int addr) {
      ...
      jcas.throwFeatMissing("nodeValue", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode");
  ...
  public boolean getLeaf(int addr) {
      ...
      jcas.throwFeatMissing("leaf", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode");
  ...
  public int getParent(int addr) {
      ...
      jcas.throwFeatMissing("parent", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode");
  ...
  public int getChildren(int addr) {
      ...
      jcas.throwFeatMissing("children", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode");
  ...
  public int getNodeTags(int addr) {
      ...
      jcas.throwFeatMissing("nodeTags", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode");
  ...
  public TreebankNode_Type(JCas jcas, Type casType) {
    ...
    casFeat_parent = jcas.getRequiredFeatureDE(casType, "parent", "edu.mayo.bmi.uima.core.type.syntax.TreebankNode", featOkTst);
    ...
    casFeat_nodeTags = jcas.getRequiredFeatureDE(casType, "nodeTags", "uima.cas.StringList", featOkTst);
