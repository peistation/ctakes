...
public class WordToken_Type extends BaseToken_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.syntax.WordToken");
  ...
  public int getCapitalization(int addr) {
      ...
      jcas.throwFeatMissing("capitalization", "edu.mayo.bmi.uima.core.type.syntax.WordToken");
  ...
  public int getNumPosition(int addr) {
      ...
      jcas.throwFeatMissing("numPosition", "edu.mayo.bmi.uima.core.type.syntax.WordToken");
  ...
  public String getSuggestion(int addr) {
      ...
      jcas.throwFeatMissing("suggestion", "edu.mayo.bmi.uima.core.type.syntax.WordToken");
  ...
  public String getCanonicalForm(int addr) {
      ...
      jcas.throwFeatMissing("canonicalForm", "edu.mayo.bmi.uima.core.type.syntax.WordToken");
