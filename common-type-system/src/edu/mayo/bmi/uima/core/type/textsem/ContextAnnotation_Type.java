...
public class ContextAnnotation_Type extends IdentifiedAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.textsem.ContextAnnotation");
  ...
  public String getFocusText(int addr) {
      ...
      jcas.throwFeatMissing("FocusText", "edu.mayo.bmi.uima.core.type.textsem.ContextAnnotation");
  ...
  public String getScope(int addr) {
      ...
      jcas.throwFeatMissing("Scope", "edu.mayo.bmi.uima.core.type.textsem.ContextAnnotation");
