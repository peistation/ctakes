...
public class Segment_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.textspan.Segment");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.mayo.bmi.uima.core.type.textspan.Segment");
