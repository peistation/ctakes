...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.core.type.textspan.Sentence");
  ...
  public int getSentenceNumber(int addr) {
      ...
      jcas.throwFeatMissing("sentenceNumber", "edu.mayo.bmi.uima.core.type.textspan.Sentence");
  ...
  public String getSegmentId(int addr) {
      ...
      jcas.throwFeatMissing("segmentId", "edu.mayo.bmi.uima.core.type.textspan.Sentence");
