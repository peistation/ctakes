 ...
 * under the License.
 */
package org.apache.ctakes.padtermspotter.util;
...
public class JCasUtil {
	...
	public synchronized static boolean isInstanceOf(String jcasObjClassName,
			Object obj) throws ClassNotFoundException, NoSuchFieldException,
			IllegalAccessException {
		Class c = Class.forName(jcasObjClassName);
