...
-[red]#ExternalBaseAggregateTAE#, ;;
-[red]#SentenceAdjuster#, ;;
-[red]#ClassifiableEntriesAnnotator#, ;;
+
[red]#Red# text indicates shipped with this annotator.
[NOTE]
=======================================================================
...
-[red]#KuRuleBasedClassifierAnnotator#, ;;
+
[red]#Red# text indicates shipped with this annotator.
[NOTE]
=======================================================================
...
-[red]#PcsClassifierAnnotator_libsvm#, ;;
-[red]#ArtificialSentenceAnnotator#, ;;
-[red]#SentenceAdjuster#, ;;
-[red]#SmokingStatusDictionaryLookupAnnotator#, ;;
-[red]#NegationAnnotator#, ;;
+
[red]#Red# text indicates shipped with this annotator.
[NOTE]
=======================================================================
...
+
The file +desc/analysis_engine/ExternalBaseAggregateTAE.xml+ provides an aggregate flow for the external annotations, SimpleSegmentAnnotator, TokenizerAnnotator, SentenceDetectorAnnotator, and LvgAnnotator.;;

-[red]#SimpleSegmentAnnotator#, ;;
-TokenizerAnnotator <<tokenizer_annot,(core project)>>, ;;
...
2) Run the script edu.mayo.bmi.smoking.MLutil.GenerateTrainingData.java on the sentence-level smoking status data to generate the libSVM training data.;; In this script, the variable "dataFile" in main() must point to the sentence-level smoking status data. Set the other variables also if necessary. Users might create their own keywordFile that contains keywords used in 
smoking status classification (see GenerateTrainingData.java for details.)

3) Create new model on the libSVM training data.;; The command with our options used in the current model is: 
