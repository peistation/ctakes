...
public class ClearParserDependencyParserAE extends JCasAnnotator_ImplBase {
	...
	public static final String DEFAULT_MODEL_FILE_NAME = "/dpresources/dependency/conll-2009-dev-shift-pop.jar";

	public static final String ENG_LEMMATIZER_DATA_FILE = "/dpresources/lemmatizer/wordnet-3.0-lemma-data.jar";
