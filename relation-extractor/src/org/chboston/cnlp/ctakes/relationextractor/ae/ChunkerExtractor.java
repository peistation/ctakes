...
public class ChunkerExtractor implements RelationFeaturesExtractor {

	  /**
	   * All chunk tags of the mention as a bag
	   */
	
	  private SimpleFeatureExtractor chunker = new TypePathExtractor(Chunk.class, "chunkType");
	  
	  private SimpleFeatureExtractor tokenChunk = new ContextExtractor<Chunk>(
		  Chunk.class,
	      chunker,
	      new Bag(new Covered()));
