 ...
 *
 */
public class RunTestGoldEntityReaderCPE extends Thread {

	private CollectionProcessingEngine mCPE;

	public RunTestGoldEntityReaderCPE() throws Exception {

		String descriptor = "desc/collection_processing_engine/TestGoldEntityReaderCPE.xml";
	...
	public static void main(String[] args) throws Exception {
		...
		new RunTestGoldEntityReaderCPE();
	}
}
