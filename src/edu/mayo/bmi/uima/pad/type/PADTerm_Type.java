 ...
 * @generated */
public class PADTerm_Type extends NamedEntity_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (PADTerm_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = PADTerm_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new PADTerm(addr, PADTerm_Type.this);
  			   PADTerm_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new PADTerm(addr, PADTerm_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = PADTerm.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.mayo.bmi.uima.pad.type.PADTerm");
  ...
  public String getHitDictionaryValue(int addr) {
      ...
      jcas.throwFeatMissing("hitDictionaryValue", "edu.mayo.bmi.uima.pad.type.PADTerm");
  ...
  public int getIsStandAlone(int addr) {
      ...
      jcas.throwFeatMissing("isStandAlone", "edu.mayo.bmi.uima.pad.type.PADTerm");
  ...
  public int getRelatedTokens(int addr) {
      ...
      jcas.throwFeatMissing("relatedTokens", "edu.mayo.bmi.uima.pad.type.PADTerm");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public PADTerm_Type(JCas jcas, Type casType) {
    super(jcas, casType);
